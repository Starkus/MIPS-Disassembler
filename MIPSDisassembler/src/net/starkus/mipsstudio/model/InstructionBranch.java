...
public class InstructionBranch extends InstructionOneReg {
	
	protected int offset;
	
	public InstructionBranch(String name, int word)
	{
		super(name, word);
	...
	{
		return String.format("%s %s, $%08X", getName(), RS, makeAbsoluteAddress(programCounter));
	}
